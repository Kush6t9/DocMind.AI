...
export default function LoginScreen({ onLoginSuccess, isVerifying, setIsVerifying }: LoginScreenProps) {
  ...
  return (
    <div className="h-screen w-screen bg-bg-base text-slate-100 font-sans selection:bg-sky-500/20 overflow-y-auto relative scroll-smooth" id="landing-page-root">
      ...
      {/* FIXED HEADER */}
      <header className="h-16 border-b border-slate-900/60 flex items-center justify-between px-8 bg-bg-base/75 backdrop-blur-lg sticky top-0 z-50">
        ...
        <nav className="hidden md:flex items-center gap-1 bg-bg-surface/80 border border-slate-800 rounded-full px-1.5 py-1">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-5 py-2 rounded-full bg-sky-500 hover:bg-sky-400 text-slate-950 text-xs font-bold transition-all cursor-pointer shadow-md active:scale-95"
        >
      ...
      <section id="hero" className="min-h-[calc(100vh-4rem)] max-w-7xl w-full mx-auto px-8 py-12 flex flex-col lg:flex-row items-center gap-12 justify-center relative">
        ...
        <div className="flex-1 text-left space-y-6 max-w-2xl">
          ...
          <p className="text-sm md:text-base text-slate-400 leading-relaxed max-w-xl font-normal">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <button
              onClick={() => login()}
              className="px-6 py-3 rounded-full bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold text-sm transition-all cursor-pointer shadow-lg hover:shadow-sky-500/10 flex items-center gap-2 active:scale-95"
            >
        ...
        {/* Right side visualization: Interactive Chat Mockup (Matches screenshot exactly, themed Sky-Blue) */}
        <div className="flex-1 w-full max-w-lg bg-bg-surface border border-slate-800/80 rounded-3xl p-6 shadow-2xl relative shrink-0">
          ...
          <div className="space-y-4 min-h-[160px] flex flex-col justify-end">
            ...
            <div className="self-start max-w-[90%] flex gap-2.5 items-start">
              ...
              <div className="bg-bg-surface-raised/40 border border-slate-800/80 rounded-2xl rounded-tl-none px-4 py-3 text-xs text-slate-300 leading-relaxed font-normal space-y-3">
                <p>
      ...
      {/* WORKFLOW SECTION */}
      <section id="workflow" className="py-20 border-t border-slate-900/60 max-w-6xl w-full mx-auto px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="bg-bg-surface border border-slate-800/80 rounded-3xl p-6 space-y-5 shadow-xs relative overflow-hidden group hover:border-sky-500/25 transition-all duration-300">
      ...
      {/* THE TOOLKIT SECTION */}
      <section id="toolkit" className="py-20 border-t border-slate-900/60 max-w-6xl w-full mx-auto px-8 space-y-12 mb-12">
        <div className="text-left space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {/* Chat bento */}
          <div className="bg-bg-surface border border-slate-800/80 rounded-3xl p-6 md:col-span-2 space-y-4 hover:border-sky-500/20 transition-all">
            <div className="flex items-center gap-2">
            ...
            <div className="bg-bg-surface-raised border border-slate-850 p-4 rounded-2xl max-w-md space-y-2 font-mono text-[11px] text-slate-500">
              ...
              <p className="text-slate-350"><span className="text-sky-400 font-bold">WikiText-103</span> — perplexity dropped to <span className="text-teal-400 font-bold">18.3</span>, a 12% gain ([T14]).</p>
            </div>
          </div>

          {/* Summary bento */}
          <div className="bg-bg-surface border border-slate-800/80 rounded-3xl p-6 space-y-4 hover:border-teal-500/20 transition-all flex flex-col justify-between">
          ...
          {/* Keypoints bento */}
          <div className="bg-bg-surface border border-slate-800/80 rounded-3xl p-6 space-y-4 hover:border-indigo-500/20 transition-all flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
          ...
          <div className="bg-bg-surface border border-slate-800/80 rounded-3xl p-6 space-y-4 hover:border-orange-500/20 transition-all">
            <div className="flex items-center gap-2">
          ...
          {/* Flashcards bento */}
          <div className="bg-bg-surface border border-slate-800/80 rounded-3xl p-6 space-y-4 hover:border-purple-500/20 transition-all">
            <div className="flex items-center gap-2">
          ...
          {/* Translate bento */}
          <div className="bg-bg-surface border border-slate-800/80 rounded-3xl p-6 space-y-4 hover:border-cyan-500/20 transition-all">
            <div className="flex items-center gap-2">
